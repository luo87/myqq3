...
*/
#define QQ09_LOCALE {0x00,0x00,0x08,0x04,0x01,0xE0}
#define QQ09_VERSION_SPEC {0x00,0x00,0x03,0x50,0x00,0x00,0x00,0x01,0x00,0x00,0x0D,0x6F}
#define QQ09_EXE_HASH {0xC1,0xF7,0xD0,0xF0,0xEE,0x9F,0x4D,0x33,0xA8,0x51,0xBA,0x7D,0xDF,0xF3,0xEE,0xC7} 
